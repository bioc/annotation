...
<table width="100%">
  ...
  <tr>
    <td> TxDb </td>
    <td>
    [TxDb.Hsapiens.UCSC.hg19.knownGene](http://bioconductor.org/packages/TxDb.Hsapiens.UCSC.hg19.knownGene/) </td>
    <td> Transcriptome ranges for the known gene track of Homo sapiens,
         e.g., introns, exons, UTR regions. </td>
  </tr>
  <tr>
    <td> OrgDb </td>
    <td> [org.Hs.eg.db](http://bioconductor.org/packages/org.Hs.eg.db/) </td>
  ...
  <tr>
    <td> BSgenome </td>
    <td>
    [BSgenome.Hsapiens.UCSC.hg19](http://bioconductor.org/packages/BSgenome.Hsapiens.UCSC.hg19/) </td>
    <td> Full genome sequence for Homo sapiens. </td>
  </tr>
  <tr>
    <td> OrganismDb </td>
    <td> [Homo.sapiens](http://bioconductor.org/packages/Homo.sapiens/) </td>
    <td> Collection of multiple annotations for a common organism
         and genome build. </td> 
  </tr>
  <tr>
    <td> AnnotationHub </td>
    <td> [AnnotationHub](http://bioconductor.org/packages/AnnotationHub/) </td>
